init = false
-- FreemodeHG version 0.3 - faunap_edit_0.2 - illa3d_edit_0.5
...
label TalkMenu(human, hitTri)
	...
	+ "HEY, " .. human.Name ..".."[gold]
		...
		+ "Hands.."[gold]
			...
			+ "X CLOSE"
		-- + "Look at.."[gold]
			-- For now buggy with multiple characters
			-- + "Actor A: Look at"
...
function OnPenetration(girl, holeName, inVelocity, outVelocity, penetrator)
	...
	if inVelocity > climaxtreshold then
		tier = "climax"
		pauseMax = 0.1 -- Orgasm audio files: ~0.3s + pause
	...
	elseif inVelocity > fasttreshold then
		tier = "fast"
		pauseMax = 0.6 -- Orgasm audio files: ~0.5s + pause
