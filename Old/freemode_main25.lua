...
function OnPenetration(girl, holeName, inVelocity, outVelocity, penetrator)
	...
	local crawlthreshold = 0.125
	local slowthreshold = 0.25
	local normalthreshold = 0.325
	local mediumthreshold = 0.5
	local fasttreshold = 0.66
	local ultratreshold = 0.82

	if inVelocity > 0.01 and inVelocity < crawlthreshold and lastMoanTime > 6 then 
		girl.SayCustom(girl.Name.."_moan_slow")
		girl.SayCustom("gen_moan_slow")
		ResetTimer(key)
	elseif inVelocity >= crawlthreshold and inVelocity < slowthreshold and lastMoanTime > 4 then 
		girl.SayCustom(girl.Name.."_moan_slow")
		girl.SayCustom("gen_moan_slow")
		ResetTimer(key)
	elseif inVelocity >= slowthreshold and inVelocity < normalthreshold and lastMoanTime > 2 then 
		girl.SayCustom(girl.Name.."_moan_slow")
		girl.SayCustom("gen_moan_slow")
		ResetTimer(key)
	elseif inVelocity >= normalthreshold and inVelocity < mediumthreshold and lastMoanTime > 2 then 
		girl.SayCustom(girl.Name.."_moan_normal")
		girl.SayCustom("gen_moan_normal")
		ResetTimer(key)
	elseif inVelocity >= mediumthreshold and inVelocity < fasttreshold and lastMoanTime > 1.5 then 
		girl.SayCustom(girl.Name.."_moan_normal")
		girl.SayCustom("gen_moan_normal")
		ResetTimer(key)
	elseif inVelocity >= fasttreshold and inVelocity < ultratreshold and lastMoanTime > 1.2 then 
		girl.SayCustom(girl.Name.."_moan_fast")
		girl.SayCustom("gen_moan_fast")
		ResetTimer(key)
	elseif inVelocity >= ultratreshold and lastMoanTime > 0.1 then 
		girl.SayCustom(girl.Name.."_moan_fast")
		girl.SayCustom("gen_moan_fast")
		ResetTimer(key)
	end
