		...
		+ "Customize.."[gold]
			...
			+ if human.Penis.IsActive
				+ "Penis.. | L:" .. penislength .. " | S:".. penissize[gold]
					+ "< Length"
						penislength = penislength - sizestepB
