init = false
-- FreemodeHG version 0.3 - faunap_edit_0.2 - illa3d_edit_0.3
	...
	+ "OPTIONS.."[gold]
		...
		+ "Moaning.." [gold]
			...
			+ "< Slow Threshold"
				slowvoiceadjust = slowvoiceadjust - 0.01
				Return()
			+ "RESET Slow Threshold Offset| "  .. slowvoiceadjust [gold]
				slowvoiceadjust = 0
				Return()
			+ "Normal threshold > " .. normalvoiceadjust
				normalvoiceadjust = normalvoiceadjust + 0.01
				Return()
			+ "< Normal threshold"
				normalvoiceadjust = normalvoiceadjust - 0.01
				Return()
			+ "RESET Normal Threshold Offset | " .. normalvoiceadjust [gold]
				normalvoiceadjust = 0
				Return()
			+ "< BACK"
				Return(2)
