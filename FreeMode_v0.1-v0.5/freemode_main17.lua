		...
		+ "Customize.."[gold]
			...
			+ "Calf.. | " .. calfsize [gold]
				...
				+ "< BACK"
					Return(2)
				+ "DONE"
			+ "Thigh.. | " .. thighsize [gold]
				+ "< Thigh"
					thighsize = thighsize - sizestepC
					if (thighsize < -1)
						thighsize = -1
			...
			+ if human.m_isMale == false
				+ "Breasts.. | " .. boobsize [gold]
					...
					+ "< BACK"
						Return(2)
					+ "DONE"
				+ "Nipples.. | " .. nippsize [gold]
					+ "< Nipples"
						nippsize = nippsize - sizestepA
						if (nippsize < -1)
							nippsize = -1
			...
			+ if human.Penis.IsActive
				+ "Penis.. | L:" .. penislength .. " | S:".. penissize[gold]
					+ "< Length"
						penislength = penislength - sizestepC
						if (penislength < -0.7)
							penislength = -0.7
					...
					+ "Size >"
						...
						human.Body("Penis size", penissize)
						Return()
					+ "RESET | L:" .. penislength .. " | S:".. penissize [gold]
						penislength = 0
						penissize = 0
