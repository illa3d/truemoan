	...
	+ "SEX.."[gold]
		...
		+ "Thrust Speed.. | " .. human.Penis.Interaction.m_autoSpeed [if human.Penis.Hole ~= nil] [gold]
			+ "4 Fastest"
				...
				Return()
			+ "3 Fast"
				human.Penis.Interaction.m_autoSpeed = 0.4
				Return()
			+ "2 Medium"
				human.Penis.Interaction.m_autoSpeed = 0.2
				Return()
			+ "1 Slow"
				human.Penis.Interaction.m_autoSpeed = 0.1
				Return()
			+ "Faster >"
		...
		+ "Suck Speed.. | " .. human.Mouth.Fucker.Penis.Interaction.m_autoSpeed [if human.Mouth.Fucker ~= nil] [gold]
			+ "4 Fastest"
				human.Mouth.Fucker.Penis.Interaction.m_autoSpeed = 1
				Return()
			+ "3 Fast"
				human.Mouth.Fucker.Penis.Interaction.m_autoSpeed = 0.4
				Return()
			+ "2 Medium"
				human.Mouth.Fucker.Penis.Interaction.m_autoSpeed = 0.2
				Return()
			+ "1 Slow"
...
function OnPenetration(girl, holeName, inVelocity, outVelocity, penetrator)
	...
	local fasttreshold1 = 0.6
	local fasttreshold2 = 0.7
	local fasttreshold3 = 0.8
	...
	elseif inVelocity >= slowthreshold1 and inVelocity < slowthreshold2 and lastMoanTime > 4 then 
		...
		girl.SayCustom("gen_moan_slow")
		ResetTimer(key)
	elseif inVelocity >= slowthreshold2 and inVelocity < normalthreshold1 and lastMoanTime > 2 then 
		girl.SayCustom(girl.Name.."_moan_slow")
		girl.SayCustom("gen_moan_slow")
		ResetTimer(key)
	elseif inVelocity >= normalthreshold1 and inVelocity < normalthreshold2 and lastMoanTime > 1.6 then 
		girl.SayCustom(girl.Name.."_moan_normal")
		girl.SayCustom("gen_moan_normal")
		ResetTimer(key)
	elseif inVelocity >= normalthreshold2 and inVelocity < fasttreshold1 and lastMoanTime > 1 then 
		girl.SayCustom(girl.Name.."_moan_normal")
		girl.SayCustom("gen_moan_normal")
		ResetTimer(key)
	elseif inVelocity >= fasttreshold1 and inVelocity < fasttreshold2 and lastMoanTime > 0.9 then 
		girl.SayCustom(girl.Name.."_moan_fast")
		girl.SayCustom("gen_moan_fast")
		ResetTimer(key)
	elseif inVelocity >= fasttreshold2 and inVelocity < fasttreshold3 and lastMoanTime > 0.7 then 
		girl.SayCustom(girl.Name.."_moan_fast")
		girl.SayCustom("gen_moan_fast")
		ResetTimer(key)
	elseif inVelocity >= fasttreshold3 and lastMoanTime > 0.1 then 
		girl.SayCustom(girl.Name.."_moan_fast")
		girl.SayCustom("gen_moan_fast")
		ResetTimer(key)
	end
