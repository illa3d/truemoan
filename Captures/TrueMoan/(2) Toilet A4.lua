...
local point = MapPoint("map_store", Pos(-2.455, -0.07, 6.835), Rot(0, 0, 0), overridePos, overrideRot, function()
...
actorA.PlaceAt(Pos(0.011, 0.017, -0.256), Rot(0, 204.876, 0), point)
actorB.PlaceAt(Pos(-0.012, -0.016, 0.257), Rot(0, 177.803, 0), point)
...
actorA.Customize("Panties", 1, "Garter", 1, "Vest", 5, "Tie", 1, "Skirt", 1, "Heels", 2)
actorB.Customize("Boots", 1, "CottnBelt", 1, "Pants", 1, "Jacket", 1)

PoseCam(Pos(2.028, 1.181, 0.196), Pos(0.143, 0.992, -0.289), point)

NewClip().Layer(MotionLayer.PlayerPose).Fade(fadeTime).Actors(actorA).WrapMode(MotionWrap.Loop).Data(
	Hips(WPos(-0.003, 0.953, 0.114)),
	HipsRot(25.4, 0.45, -25),
	Head(-0.216, 0.626, 0.749),
	HeadRot(342.34, 261.061, 33.311),
	EyeL(CameraPos()),
	EyeR(CameraPos()),
	FootL(WPos(-0.413, 0.68, -0.064)),
...
NewClip().Layer(MotionLayer.PlayerPose).Fade(fadeTime).Actors(actorB, actorA).WrapMode(MotionWrap.Loop).Data(
	Penis(TargetActor.A, "Anus", TargetActor.Null, "", 0, 0, 0, 0, true, 1, 0.1, 0.666, 0.052, false, 0.25, 0.65, 1.25, 2.101, 1.2),
	Hips(WPos(0, 1.134, 0.271)),
	HipsRot(-16.1, 0, -3.075),
	Head(0, 0.987, 0.163),
	...
	HandL(BoneMesh(TargetActor.A, "Bone_Hips", 0.253, 0.665, 0.03), Wrist(HPoint(0, -0.3, 0.7, 90), 0, 35)),
