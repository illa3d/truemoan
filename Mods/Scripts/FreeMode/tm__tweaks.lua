...
TM_HumanArousalDecrease = 10	-- Base rate of arousal decrease (when not in sex or cumming)
...
-- Plap
TM_PlapDistanceLimit = 0.065	-- [0.02-0.23] Distance in penetration to sound plap
TM_FartDistanceLimit = 0.1		-- [0.02-0.23] Distance in penetration to sound fart
...
TM_CumflateMaxRatio = 0.8		-- Maximum amount of cumflate (so Bulging is still visible)
