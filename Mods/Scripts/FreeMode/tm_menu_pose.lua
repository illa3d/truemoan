...
label TMMenuPose(human)
	+ if TMMOD_FaunaLabs
		+ AccStr(TM_PosePrefix_Faun) .. "Arms.." [gold]
			GetMenuItems_Pose(human, TM_PoseArms_Fauna)
		+ AccStr(TM_PosePrefix_Faun) .. "Hands.." [gold]
			GetMenuItems_Pose(human, TM_PoseHands_Fauna)
		+ AccStr(TM_PosePrefix_Faun) .. "Lay.." [gold]
			GetMenuItems_Pose(human, TM_PoseBody_Fauna_Lay)
		+ AccStr(TM_PosePrefix_Faun) .. "Kneel.." [gold]
			GetMenuItems_Pose(human, TM_PoseBody_Fauna_Kneel)
		+ AccStr(TM_PosePrefix_Faun) .. "Sit.." [gold]
			GetMenuItems_Pose(human, TM_PoseBody_Fauna_Sit)
		+ AccStr(TM_PosePrefix_Faun) .. "Stand.." [gold]
			GetMenuItems_Pose(human, TM_PoseBody_Fauna_Stand)
