...
TM_PoseBody_Original = {
	...
	{ name = "Lay, back, legs spread", preset = LayDownBackSpread },
	{ name = "Lay, back", preset = LayDownBack },
	{ name = "Lay, side", preset = LayDownSide },
	{ name = "Lay, stomach", preset = LaydownStomach },
	{ name = "Doggy", preset = GetdownAll4 },
	{ name = "Kneel", preset = KneelDown },
	{ name = "Sit, legs spread", preset = SitDownSpreadLegs },
	{ name = "Sit, legs cross", preset = SittingFolded },
	{ name = "Sit", preset = SitDown },
	{ name = "Stand, Bend over", preset = BendOver },
	{ name = "Stand, T-Pose", preset = TPose },
...
TM_PoseBody_Fauna = {
	...
	-- LAY
	{ name = "On your back", preset = LayDownBack1 },
	{ name = "On your side - Right", preset = LayDownSideR },
	{ name = "On your side - Left", preset = LayDownSideL },
	{ name = "On your stomach", preset = LaydownStomach1 },
	{ name = "Hanging", preset = Hanging_1 },
	-- STAND
	{ name = "Stand", preset = StandUp1 },
	{ name = "Bend Over | Grope", preset = BendOver1 },
	{ name = "Bend Over | Lean", preset = BendOver_Lean },
	{ name = "Bend Over | Spread", preset = BendOver_Spread },
...
TM_PoseHands_Fauna = {
	{ name = "L Peace", preset = PeaceL },
	{ name = "R Peace", preset = PeaceR },
